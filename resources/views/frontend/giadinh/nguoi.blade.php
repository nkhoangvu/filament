...
<section class="content">
	<div class="container-fluid" data-aos="fade-up">
		<div class="row">		
			...
			<!-- Content -->
			<form class="form-horizontal" id="mainForm" action="{{ route('family.nguoiUpdate', [$data->MaNguoi]) }}" method="POST" enctype="multipart/form-data">
			@method('PUT')
			@csrf

			<x-nguoi.nguoi :data="$data" :Cha="$Cha" :MoTang="$MoTang" />
			
			<x-buttons.footer-submit route="family.nguoiShow" :parameter="[$data->MaNguoi]" :label="trans('common.update')"/>
