...
<section class="content">
	<div class="container-fluid">
		...
		<!-- Content -->
		<form class="form-horizontal" id="mainForm" action="{{ route('ngoai.store') }}" method="POST" enctype="multipart/form-data">
			@csrf

			<x-ngoai :Me="$Me"/>
		
			<x-buttons.footer-submit route="ngoai.index" :label="trans('common.save')"/>
