...
<section class="content">
	<div class="container-fluid">
		...
		<!-- Content -->
		<form class="form-horizontal" id="mainForm" action="{{ route('tag.store') }}" method="POST" enctype="multipart/form-data">
			@csrf

		<x-backend.tag :title="trans('common.create')" />
