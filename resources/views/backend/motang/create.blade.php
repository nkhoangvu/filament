...
<section class="content">
	<div class="container-fluid">
		...
		<!-- Content -->
		<form class="form-horizontal" id="mainForm" action="{{ route('motang.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
		
		<x-motang :nguoi="$nguoi"/>
		
		<x-buttons.footer-submit route="motang.index" :label="trans('common.save')" />
