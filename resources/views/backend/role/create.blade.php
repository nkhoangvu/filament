		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('role.index') }}">@yield('pageTitle')</a></li>
					<li class="breadcrumb-item active">{{ trans('common.create')}}</a></li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="col-12">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">{{ trans('common.role_new') }}</h3>
					...
					<!-- Content begin -->
					<div class="card-body">					
						<form class="form-horizontal" id="mainForm" action="{{ route('role.store') }}" method="POST" enctype="multipart/form-data">
    					@csrf
						<div class="row">
						...
						<div class="row">
							<div class="form-group col">
								...
								<div class="col-md-12">
									<input type="text" id="display_name" class="form-control" x-model="displayName" name="display_name"/>
								</div>
							</div>
						</div>
						<div class="row">
