    ...
    <div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
      <div class="col">
        <div class="flex items-center pt-8 sm:justify-start sm:pt-0 justify-content-center">
            <h1 class="headline px-4 text-warning border-r border-gray-400"> <strong>404</strong></h1>
            <div class="error-content">
              <h3 class="ml-4"><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Page not found.</h3>
